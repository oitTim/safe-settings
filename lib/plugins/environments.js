        ...
        if (this.entries) {
            this.entries.forEach(environment => {
              ...
              if (environment.deployment_branch_policy && environment.deployment_branch_policy.custom_branch_policies) {
                if (environment.deployment_branch_policy.custom_branch_policies.length > 0) {
                  const newArray = []
                  ...
                  environment.deployment_branch_policy.custom_branch_policies = newArray
                }
              }
